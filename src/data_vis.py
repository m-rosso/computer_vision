...
class BoxPlot(BasePlot):
    ...
    def add_plot(self, data: pd.DataFrame, x: str, y: Union[str, List[str]],
                 ...
                 colors: Optional[List[str]] = None,
                 y_lim: Optional[tuple] = None,
                 y_lim_sec: Optional[tuple] = None,
                 boxmean: bool = True) -> None:
        """
        ...
        :param y_lim_sec: limits of secondary y-axis.
        :type y_lim_sec: tuple.
        :param boxmean: indicates whether to plot mean in the boxplot.
        :type boxmean: boolean.
...
class HistoPlot(BasePlot):
    ...
    def add_plot(self, data: pd.DataFrame, x: str,
        ...
        :type x_name: string.
        :param barmode: how to plot multiple histograms.
        :type barmode: string.
        :param x_axis_name: name of x-axis.
        :type x_axis_name: string.
...
####################################################################################################################################
# Class for creating a grid of plots of mixed types:
...
class Plot(BasePlot):
    ...
    def add_plot(self, data: pd.DataFrame, x: str,
        ...
        :param position: position in the grid.
        :type position: tuple.
        :param plot_type: type of plot. Choose among "scatter", "line" and "bar".
